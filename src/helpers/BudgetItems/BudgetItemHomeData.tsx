...
export default function BudgetItemHomeData({
  budgetItems,
  addBudgetItem,
  editBudgetItem,
}: {
    ...
    return (
      ...
      >
        ...
        <td className="border-x-2 p-3 text-center">
          <FontAwesomeIcon icon={budgetItem.accumulates ? faCheck : faXmark} />
        </td>
      ...
      <caption className="text-left text-2xl font-semibold uppercase pb-5">
        <div className="flex justify-between items-center">
          ...
          <div className="text-base">
            <AddButton buttonType="button" text="Add" onEvent={addBudgetItem} />
          </div>
        </div>
      </caption>
